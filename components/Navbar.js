    ...
    <div className="max-w-6xl px-4 py-10 mx-auto md:py-20">
      <div className="flex items-center justify-between md:flex-row">
        ...
        <div className="flex flex-col">
          <Link href="/">
            <a>
              <h1 className="text-xl font-semibold dark:text-gray-100 hover:underline">
                {userData.name}
              </h1>
              <p className="text-base font-light text-gray-500 dark:text-gray-300 hover:underline hover:text-blue-800">
        ...
        <div className="flex flex-row items-center space-x-4">
          ...
          <a
            ...
            className="text-base font-normal text-blue-900 dark:text-blue-700"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
      ...
      <div className="block mt-4 space-x-8 md:hidden">
        <Link href="/about">
          <a className="text-base font-normal text-gray-600 dark:text-gray-300 hover">
            About
          </a>
        </Link>
        <Link href="/projects">
