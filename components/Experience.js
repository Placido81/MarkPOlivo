...
export default function Experience() {
  return (
    <section className="bg-[#1B8EF2] dark:bg-gray-700 ">
...
const ExperienceCard = ({ title, desc, year, company, companyLink }) => {
  return (
    <div className="relative z-10 p-4 mx-4 bg-white border rounded-md shadow-xl experience-card dark:bg-gray-700 ring-red-600 ring-4 inset-15">
