...
export default function Contact() {
  return (
    <section>
      <div className="h-48 max-w-5xl mx-auto transform skew-x-12 -rotate-5 bg-[#1B8EF2] dark:bg-gray-800 "id="contact-container">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="md:ml-4">
            ...
            <div className="inline-flex flex-col my-20 icons-container">
              <div className="flex flex-row items-center space-x-6 rounded-md border border-[#02044A] hover:border hover:border-yellow-300  p-4">
                <svg
          ...
          <form className="flex flex-col p-4 bg-white rounded-lg form">
            ...
            <input
              type="text"
              className="px-1 py-2 mx-4 mt-2 font-light text-red-700 border rounded-md focus:outline-none focus:ring-2 focus:border-none ring-blue-500"
              name="name"
            />
            ...
            <input
              type="text"
              className="px-1 py-2 mx-4 mt-2 font-light text-red-700 border rounded-md focus:outline-none focus:ring-2 ring-blue-500"
              name="email"
            />
            <label
              htmlFor="message"
            ...
            <button
              type="submit"
              className="w-1/2 py-2 mx-4 mt-8 text-xs font-bold bg-blue-500 rounded-md text-gray-50 ring-yellow-300 ring-4 hover:bg-red-600"
            >
              Send Message
            </button>
          </form>
