  ...
  return (
    <div className="bg-[#F1F1F1] dark:bg-gray-700">
      <div className="max-w-6xl px-4 py-10 mx-auto md:py-20">
        <div className="h-0.5 w-full bg-gray-100 dark:bg-yellow-300"></div>
        <div className="flex flex-col justify-between mt-8 space-y-5 md:space-y-0 md:flex-row md:items-center">
          ...
          <div>
            <p className=" sm:place-items-center">
              Developed by  
          ...
          <div className="flex flex-row items-center md:space-x-4">
            ...
            class="feather sm:feather-github">
            ...
            >
              <svg
                ...
                height="16"
                fill="currentColor"
                className="w-5 h-5 text-blue-500 sm:bi bi-twitter"
                viewBox="0 0 16 16"
              >
